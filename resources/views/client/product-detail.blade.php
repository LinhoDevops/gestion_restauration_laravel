            ...
            <div class="container text-center pb-5">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        <li class="breadcrumb-item"><a href="{{ route('client.catalog') }}">Menu</a></li>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="d-flex flex-wrap pb-4 m-n1">
                        ...
                        <small class="bg-light rounded py-1 px-3 m-1">
                            <i class="fa fa-box text-burger me-2"></i>Stock: {{ $product->stock }}
                        </small>
                    </div>
                    ...
                    @if($product->stock > 0)
                        <form action="{{ route('client.cart.add') }}" method="POST" class="mt-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-9">
                                    <button type="submit" class="btn btn-burger py-3 px-5 w-100 h-100">Ajouter au panier</button>
                                </div>
                            </div>
                        </form>
                    @endif
